  ...
  _createClass(domainr, [{
    ...
    value: function search(properties) {
      ...
      return new Promise(function (resolve, reject) {
        apiRequest(_this.mashapeKey, 'search', queryObj).then(function (data) {
          resolve(data.search);
        }).catch(function (err) {
          reject(err);
        });
    ...
    value: function status(domainArray) {
      ...
      return new Promise(function (resolve, reject) {
        apiRequest(_this2.mashapeKey, 'status', { domain: domainArray.join(',') }).then(function (data) {
          resolve(data.status);
        }).catch(function (err) {
          reject(err);
        });
    ...
    key: 'register',
    value: function register(domain, registrar) {
      var _this3 = this;
      ...
      var requestObject = { domain: domain };
      if (registrar) requestObject.registrar = registrar;

      return new Promise(function (resolve, reject) {
        apiRequest(_this3.mashapeKey, 'register', requestObject).then(function (response) {
